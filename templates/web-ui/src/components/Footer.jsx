    ...
    <>
      ...
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-8">
          ...
          {/* Payment Methods */}
          <div>
            <h3 className="text-lg font-bold mb-4 text-jumia-orange">Payment Methods</h3>
            <div className="flex flex-wrap gap-2 mb-4">
              <div className="bg-white rounded p-2 text-xs text-gray-800">Visa</div>
              <div className="bg-white rounded p-2 text-xs text-gray-800">Mastercard</div>
              <div className="bg-white rounded p-2 text-xs text-gray-800">PayPal</div>
              <div className="bg-white rounded p-2 text-xs text-gray-800">Pay on Delivery</div>
            </div>
            <p className="text-sm text-gray-300">Secure payment options available</p>
          </div>

          {/* Follow Us */}
          <div>
            <h3 className="text-lg font-bold mb-4 text-jumia-orange">Follow Us</h3>
            <div className="flex space-x-4 mb-4">
              <a
                href="https://facebook.com"
                target="_blank"
                rel="noopener noreferrer"
                className="w-10 h-10 bg-white bg-opacity-10 rounded-full flex items-center justify-center hover:bg-jumia-orange transition"
              >
        ...
        <div className="border-t border-gray-700 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center">
            ...
            <div className="flex space-x-4 text-sm text-gray-400">
              ...
              <a href="/cookies" className="hover:text-jumia-orange transition">
                Cookies
              </a>
            </div>
          </div>
